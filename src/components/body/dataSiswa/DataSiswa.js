...
function DataSiswa({ tableHeaders, totalData, handleSearch, searchTerm, setSearchTerm, currentPage, itemsPerPage, handlePageChange, startIndex, endIndex }) {
  ...
  return (
    <div className="w-full h-full">
      ...
      <Routes>
        <Route path="/data-siswa/tambah-siswa" element={<Tambah setShowTambah={setShowTambah} />} />
      </Routes>
    </div>
