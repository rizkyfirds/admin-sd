...
function LombaExternal({
  ...
  return (
    <div className="w-full h-full">
      <h1 className="font-bold text-4xl font-['Segoe UI']">Lomba External</h1>
      <div className="mt-8 mb-32 h-fit bg-white">
        <div className="flex pt-6 ml-8">
          <div className="font-bold mx-auto text-xl">Form Lomba External</div>
        </div>
